...
import { suggestMappingRestricao } from "../api";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-100 flex flex-col items-center justify-center py-8">
      <div className="bg-white shadow-xl rounded-2xl p-10 w-full max-w-md flex flex-col items-center space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold text-blue-700">Restrições</h1>
          <p className="text-gray-500 text-sm">
            As restrições serão lidas da aba{" "}
            <span className="font-semibold text-gray-700">Restricao</span> do
            mesmo arquivo já carregado.
          </p>
        </div>
